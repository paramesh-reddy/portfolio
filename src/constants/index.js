...
const experiences = [
  {
    title: "SDE - 1 @ Frontend Web Developer",
...
const projects = [
  ...
  },
  {
    ...
    description:
      "It is a web application that provides nutrition information and cooking instructions for various foods and recipes, featuring user login, lazy loading, search options, and social media sharing",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    description:
      "I developed mobile and web applications, including a live chat app with WebSockets for real-time messaging, utilizing React.js and Node.js, deployed on AWS EC2 with Docker and Nginx",
    tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    description:
      "I developed an AI agent model similar to ChatGPT using React.js, Django, and PostgreSQL, integrated with OpenAI, and deployed on AWS EC2 with Docker and Nginx.",
    tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    description:
      "I created a dynamic AI builder using the Lyzr Agent API to configure LLMbased agents, simplifying agent setup and task management for personalized AI automation.",
    tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
